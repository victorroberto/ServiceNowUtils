...
getEmpolyeeInfo.prototype = Object.extendsObject(AbstractAjaxProcessor, {
  ...
  verifyGroup: function () {
    ...
    groupGR.addEncodedQuery(
      "group=c24f95821b83f810b71beca0f54bcb54^user=" + user
    );
    groupGR.query();
  ...
  function callback(response) {
    ...
    if (objUser.department == "") {
      g_form.addErrorMessage(
        "O usuário selecionado não possui departamento configurado no AD, portanto não poderá seguir com a solicitação. Entre em contato com o time de Gestão de Acessos para corrigir."
      );
