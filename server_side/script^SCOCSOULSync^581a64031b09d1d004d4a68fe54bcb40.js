...
SC_OC_SOUL_Sync.prototype = {
    ...
    syncSc: function (integrador_gr, registroLog) {
        ...
        if (integrador_gr.getValue('u_data') == null) {
            ...
            this._insereLog('atualizaWorklog', registroLog, 'Solicitações de Compra - MVSOUL: ' + integrador_gr.getValue('u_data'), '', '');
        }
    ...
    syncOc: function (integrador_gr, registroLog) {
        ...
        if (integrador_gr.getValue('u_data') == null) {
            ...
            this._insereLog('atualizaWorklog', registroLog, 'Ordens de Compra - MVSOUL: ' + integrador_gr.getValue('u_data'), '', '');
        }
    ...
    buscaOC: function (numero) {
        ...
        var query = gs.getMessage("u_numero_da_ordem={0}^u_sistema_de_origem=SOULMV", [numero]);
    ...
    buscaSC: function (numero) {
        ...
        var query = gs.getMessage("u_numero_da_solicitacao={0}^u_sistema_de_origem=SOULMV", [numero]);
