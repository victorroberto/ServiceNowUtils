...
SC_OC_MV_Sync.prototype = {
  ...
  syncSc: function (integrador_gr, registroLog) {
    ...
    if (integrador_gr.getValue("u_data") == null) {
      ...
      this._insereLog(
        "atualizaWorklog",
        registroLog,
        "Solicitações de Compra - MV2000: " + integrador_gr.getValue("u_data"),
        "",
        ""
      );
    }
    ...
    this._insereLog(
      "atualizaWorklog",
      registroLog,
      "Todas as solicitações do MV2000 processadas",
      "",
      ""
    );
  },
  ...
  syncOc: function (integrador_gr, registroLog) {
    ...
    if (integrador_gr.getValue("u_data") == null) {
      ...
      this._insereLog(
        "atualizaWorklog",
        registroLog,
        "Ordens de Compra - MV2000: " + integrador_gr.getValue("u_data"),
        "",
        ""
      );
    }
    ...
    this._insereLog(
      "atualizaWorklog",
      registroLog,
      "Todas as ordens do MV2000 processadas",
      "",
      ""
    );
  },
  ...
  buscaOC: function (numero) {
    ...
    var query = gs.getMessage(
      "u_numero_da_ordem={0}^u_sistema_de_origem=MV2000_WS",
      [numero]
    );
  ...
  buscaSC: function (numero) {
    ...
    var query = gs.getMessage(
      "u_numero_da_solicitacao={0}^u_sistema_de_origem=MV2000_WS",
      [numero]
    );
